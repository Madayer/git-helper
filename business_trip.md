...
Воронка обращаемости. Сквозную отчетность на текущем этапе развития систем-источников возможно только через сущности: оператор, территория, продукт, служба и т.д.
